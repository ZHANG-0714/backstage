<template>
  ...
  <div>
    <el-card>
      <el-table :data="power" style="width: 100%" border stripe align="center">
          ...
          <template slot-scope="scope">
            <el-popover trigger="hover" placement="top">
              <div slot="reference" class="name-wrapper">
                ...
                <el-tag size="medium" v-if="scope.row.level === '1'">二级</el-tag>
                <el-tag size="medium" v-if="scope.row.level === '2'">三级</el-tag>
              </div>
            </el-popover>
          </template>
        </el-table-column>
